...
<div class="max-width" style="margin-left: -15px;">
    ...
    <div class="row">
        <?php
        if (get_the_category()[0]->slug != 'industryapp' and get_the_title() != '公司简介'){
            ...
            <div class="panel-group block-shadow" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingOne">
                        <a data-toggle="collapse" data-parent="#accordion" href="sec/#collapseOne" aria-expanded="true"
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <img style="margin-right: auto;margin-left: auto;" class="img-responsive"
                                 src="<?php echo get_bloginfo('template_url') . '/img/weixin.jpg'?>"
                ...
                <div class="panel">
                    <div class="panel-heading" role="tab" id="headingTwo">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="sec/#collapseTwo"
        ...
        <div class="col-xs-9">
            ...
            <div class="col-md-12">
                ...
                <div style="min-height:600px; width:100%;">
                    ...
                    <h3 class="title" style="float:left;margin-top:35px;color: #00aff0;">
                        <?php
                        the_title();
                        ?>
                    </h3>
